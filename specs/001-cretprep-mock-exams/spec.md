...
3. **Given** the user completes the last question, **When** they view results, **Then** the results page shows final score, percentage, counts of correct/incorrect, and a question-by-question review including explanations if provided by AI.
...
- **FR-002**: System MUST allow the user to choose the number of questions to generate via a custom numeric input.
...
- **FR-006**: The exam UI MUST present one question at a time with four options, Next navigation, and a question progress indicator (e.g., 3/10).
